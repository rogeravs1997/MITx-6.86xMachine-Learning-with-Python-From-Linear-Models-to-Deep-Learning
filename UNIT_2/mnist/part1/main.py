...
test_error_pca18 = compute_test_error(test_pca, test_y, theta, 1)
print('softmax_pca18 test_error=', test_error_pca18)
...
test_error_pca10_cube = compute_test_error(test_cube, test_y, theta, 1)
print('softmax_pca10_cube test_error=', test_error_pca10_cube)